  ...
  return (
    <div className="m-content">
      <div className="m-h">
        ...
        <a href="/clinics/scan-patient" className="btn btn-s" style={{ textDecoration: 'none' }}>
          Look up patient
        </a>
      </div>
            ...
            <tbody>
              {filtered.map((p: any) => (
                <tr
                  ...
                  onClick={() => router.push('/clinics/scan-patient?code=' + p.implantIdCode)}
                  tabIndex={0}
                  onKeyDown={(e) => {
                    if (e.key === 'Enter' || e.key === ' ') {
                      router.push('/clinics/scan-patient?code=' + p.implantIdCode)
                    }
                  }}
