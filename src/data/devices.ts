...
export const DOCUMENTS: Document[] = [
  ...
  { doc_id: 'DOC-000013', manufacturer_id: 'MFR-000001', device_ids: ['IID-PPM-000001', 'IID-LEAD-000001'], document_title: 'Medtronic Azure XT MRI SureScan — Specification Sheet', document_version: '', source_type: 'Manufacturer spec sheet', document_date: '2024-01-01', document_url: 'https://www.medtronic.com/content/dam/medtronic-com/01_crhf/brady/pdfs/azure-xt-dr-mri-surescan-spec-sheet.pdf', date_retrieved: '2026-06-08', is_superseded: false, superseded_by_doc_id: '', notes: 'Official Medtronic Azure XT MRI SureScan spec sheet PDF from medtronic.com. Confirms model numbers W1DR01/W1SR01, SAR limits, and complete SureScan system requirements.', verified_by: 'Implant ID editorial team — URL confirmed via medtronic.com 2026-06-08' },
  { doc_id: 'DOC-000014', manufacturer_id: 'MFR-000001', device_ids: ['IID-PPM-000005'], document_title: 'Medtronic Azure S MRI SureScan — Specification Sheet', document_version: '', source_type: 'Manufacturer spec sheet', document_date: '2024-01-01', document_url: 'https://www.medtronic.com/content/dam/medtronic-com/01_crhf/brady/pdfs/azure-s-dr-mri-surescan-spec-sheet.pdf', date_retrieved: '2026-06-08', is_superseded: false, superseded_by_doc_id: '', notes: 'Official Medtronic Azure S MRI SureScan spec sheet PDF from medtronic.com. Confirms model numbers W3DR01/W3SR01.', verified_by: 'Implant ID editorial team — URL confirmed via medtronic.com 2026-06-08' },
  { doc_id: 'DOC-000015', manufacturer_id: 'MFR-000001', device_ids: ['IID-PPM-000001', 'IID-LEAD-000001', 'IID-PPM-000005'], document_title: 'Medtronic SureScan MRI Technology — HCP Overview', document_version: '', source_type: 'Manufacturer product page', document_date: '2024-01-01', document_url: 'https://www.medtronic.com/us-en/healthcare-professionals/therapies-procedures/cardiac-rhythm/mri-surescan.html', date_retrieved: '2026-06-08', is_superseded: false, superseded_by_doc_id: '', notes: 'Medtronic HCP landing page for the SureScan MRI platform. Covers compatible generators (Azure XT, Azure S) and approved leads, with clinical protocol summary.', verified_by: 'Implant ID editorial team' },
  { doc_id: 'DOC-000016', manufacturer_id: 'MFR-000006', device_ids: ['IID-ICD-000001'], document_title: 'BSC EMBLEM MRI S-ICD System — HCP Product Overview', document_version: '', source_type: 'Manufacturer product page', document_date: '2024-01-01', document_url: 'https://www.bostonscientific.com/us/en/healthcare-professionals/products/defibrillators/emblem-mri-subcutaneous-implantable-defibrillator-s-icd-system/fp90000132.html', date_retrieved: '2026-06-08', is_superseded: false, superseded_by_doc_id: '', notes: 'Boston Scientific HCP product page for the EMBLEM MRI S-ICD (A219 and A209) with ImageReady MR-Conditional technology. URL confirmed via Firecrawl scraping.', verified_by: 'Implant ID editorial team — URL confirmed via Firecrawl 2026-06-08' },
]
